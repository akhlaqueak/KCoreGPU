...
__global__ void selectNodesAtLevel6(unsigned int *degrees, unsigned int level, unsigned int V, 
...
__global__ void processNodes6(G_pointers d_p, int level, int V, 
                    unsigned int* bufTails, unsigned int* glBuffers, 
...
int kcoreBallotScanPrefetch(Graph &data_graph){
